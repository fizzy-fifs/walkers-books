...
const emits = defineEmits(['edit', 'view', 'delete'])
</script>
...
<template>
  <div class="book-card">
    ...
    <div class="book-actions">
      <el-button size="small" type="primary" @click="$emit('edit', book)">Edit</el-button>
      <el-button size="small" type="info" @click="$emit('view', book)">View</el-button>
      <el-button size="small" type="danger" @click="$emit('delete', book)">Delete</el-button>
    </div>
  </div>
</template>
